...
const genAI = new GoogleGenerativeAI('AIzaSyANsC1iZDaI98mUzVgRQtX4D9DdOWshVNs');
    ...
    <div className="mb-8">
      <div className="flex justify-center space-x-4">
        <button
          ...
          className={`px-4 py-2 text-white rounded-lg transition duration-300 flex items-center ${loading
